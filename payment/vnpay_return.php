...
<body>
    ...
    <div class="payment-container">
        ...
        <div class="payment-logo">
            <a href="/">
                <img src="/assets/img/logo/aurora-hotel-plaza-logo.png" alt="Aurora Hotel Plaza"
                ...
                <div class="transaction-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value"
                            style="max-width: 200px; text-align: right;"><?php echo $orderInfo; ?></span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Mã phản hồi</span>
                        <span class="detail-value"
                            style="color: <?php echo $isSuccess ? 'var(--success)' : 'var(--error)'; ?>;">
                ...
                <div class="action-buttons">
                    <?php if ($isSuccess): ?>
                        <?php if (!isset($_SESSION['user_id'])): ?>
                            <a href="/index.php?action=track_booking" class="btn-secondary">
        ...
        <div class="payment-footer">
            <p>© <?php echo date('Y'); ?> Aurora Hotel Plaza. Powered by <a href="https://vnpay.vn"
