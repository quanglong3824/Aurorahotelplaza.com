    ...
    <div class="relative flex min-h-screen w-full flex-col">
        ...
        <main class="flex h-full grow flex-col">
            ...
            <section class="page-header-room"
                data-bg-image="../assets/img/premium-apartment/can-ho-premium-aurora-hotel-1.jpg">
                        ...
                        <div class="booking-card">
                            <div class="price-section">
                                ...
                                <p style="font-size: 0.875rem; color: #666; margin-top: 0.5rem;">
                                    <?php _e('apartment_detail.discount_25_7days'); ?></p>
                            </div>
                            <form class="booking-form" action="../booking/index.php" method="get">
                                <input type="hidden" name="room_type" value="premium-apartment">
                ...
                <div class="container-custom">
                    ...
                    <div class="room-gallery">
                        <div class="gallery-item">
                            <img src="../assets/img/premium-apartment/can-ho-premium-aurora-hotel-1.jpg"
                                alt="Premium Apartment">
                        </div>
                        <div class="gallery-item">
                            <img src="../assets/img/premium-apartment/can-ho-premium-aurora-hotel-2.jpg"
                                alt="Premium Apartment">
                        </div>
                        <div class="gallery-item">
                            <img src="../assets/img/premium-apartment/can-ho-premium-aurora-hotel-3.jpg"
                                alt="Premium Apartment">
                        </div>
                        <div class="gallery-item">
                            <img src="../assets/img/premium-apartment/can-ho-premium-aurora-hotel-7.jpg"
                                alt="Premium Apartment">
                        </div>
                        <div class="gallery-item">
                            <img src="../assets/img/premium-apartment/can-ho-premium-aurora-hotel-8.jpg"
                                alt="Premium Apartment">
                        </div>
                    </div>
                </div>
            ...
            $currentRoom = getRoomBySlug('premium-apartment');
