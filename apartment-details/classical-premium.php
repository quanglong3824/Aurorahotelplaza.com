        ...
        <main class="flex h-full grow flex-col">
            ...
            <div class="relative min-h-[60vh] flex items-center justify-center pt-[100px] pb-12 px-4">
                ...
                <div class="absolute inset-0 z-0">
                    <img src="<?php echo imgUrl('assets/img/classical-premium-apartment/classical-premium-apartment-1.jpg.webp'); ?>"
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div class="glass-amenity-card">
                                    ...
                                    <span
                                        class="font-bold text-accent"><?php _e('apartment_detail.premium_bed'); ?></span>
                                </div>
                                <div class="glass-amenity-card">
                                ...
                                <div class="glass-amenity-card">
                                    ...
                                    <span class="font-bold text-accent">2-4
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-premium-apartment/classical-premium-apartment-2.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-premium-apartment/classical-premium-apartment-3.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                </div>
                            </div>
