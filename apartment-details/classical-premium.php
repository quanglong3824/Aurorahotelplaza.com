    ...
    <div class="relative flex min-h-screen w-full flex-col">
        ...
        <main class="flex h-full grow flex-col">
            <section class="page-header-room"
                data-bg-image="../assets/img/classical-premium-apartment/classical-premium-apartment-1.jpg">
                    ...
                    <div class="room-info-section">
                        ...
                        <div class="booking-card">
                            ...
                            <form class="booking-form" action="../booking/index.php" method="get">
                                <input type="hidden" name="room_type" value="classical-premium">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="guests" class="form-input">
                                        ...
                                        <option value="4">4 <?php _e('apartment_detail.persons'); ?></option>
                                    </select>
                                </div>
                ...
                <div class="container-custom">
                    ...
                    <div class="room-gallery">
                        <div class="gallery-item"><img
                                src="../assets/img/classical-premium-apartment/classical-premium-apartment-1.jpg"
                                alt="Classical Premium Apartment"></div>
                        <div class="gallery-item"><img
                                src="../assets/img/classical-premium-apartment/classical-premium-apartment-2.jpg"
                                alt="Classical Premium Apartment"></div>
                        <div class="gallery-item"><img
                                src="../assets/img/classical-premium-apartment/classical-premium-apartment-3.jpg"
                                alt="Classical Premium Apartment"></div>
                    </div>
                </div>
            </section>
