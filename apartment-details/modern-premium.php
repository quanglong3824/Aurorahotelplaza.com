    ...
    <style>
        ...
        body.glass-page::before {
            ...
            background: 
                ...
                url('../assets/img/modern-premium-apartment/modern-premium-apartment-1.jpg') !important;
                ...
                <div class="container mx-auto px-4 pb-16">
                    ...
                    <div class="mt-16">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div class="glass-card overflow-hidden group aspect-video">
                                <img src="<?php echo imgUrl('assets/img/modern-premium-apartment/modern-premium-apartment-4.jpg'); ?>" 
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                            <div class="glass-card overflow-hidden group aspect-video">
                                <img src="<?php echo imgUrl('assets/img/modern-premium-apartment/modern-premium-apartment-5.jpg'); ?>" 
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                        </div>
                    </div>
