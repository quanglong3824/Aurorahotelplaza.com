...
<main class="flex h-full grow flex-col">
    <section class="page-header-room" data-bg-image="../assets/img/indochine-studio-apartment/indochine-studio-apartment-1.jpg">
        <div class="page-header-overlay"></div>
        <div class="page-header-content">
            <span class="room-badge-header"><?php _e('apartment_detail.badge_indochine'); ?></span>
            <h1 class="page-title"><?php _e('apartment_detail.indochine_studio_name'); ?></h1>
            <p class="page-subtitle"><?php _e('apartment_detail.indochine_studio_subtitle'); ?></p>
        </div>
    </section>
        ...
        <div class="container-custom">
            <div class="room-info-section">
                <div class="room-content">
                    <p class="room-description"><?php _e('apartment_detail.indochine_studio_desc'); ?></p>
                    <div class="room-specs">
                        ...
                        <div class="spec-item"><div class="spec-icon"><span class="material-symbols-outlined">square_foot</span></div><div class="spec-content"><div class="spec-label"><?php _e('apartment_detail.area'); ?></div><div class="spec-value">50 m²</div></div></div>
