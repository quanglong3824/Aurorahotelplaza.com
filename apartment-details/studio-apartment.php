    ...
    <style>
        ...
        body.glass-page::before {
            ...
            background: 
                ...
                url('../assets/img/studio-apartment/can-ho-studio-aurora-hotel-1.jpg') !important;
        ...
        <main class="flex h-full grow flex-col">
            ...
            <div class="relative min-h-[60vh] flex items-center justify-center pt-[100px] pb-12 px-4">
                ...
                <div class="relative z-10 text-center max-w-4xl mx-auto">
                    <span
                        class="glass-badge-pill mb-6 mx-auto bg-accent/20 border-accent/40 text-accent"><?php _e('apartment_detail.badge_studio'); ?></span>
                    <h1
