...
class SEO {
    ...
    public static function generateMetaTags($data = []) {
        $defaults = [
            'title' => 'Aurora Hotel Plaza - Khách sạn sang trọng tại Đồng Nai',
            'description' => 'Aurora Hotel Plaza - Khách sạn 4 sao sang trọng tại trung tâm Đồng Nai. Phòng đẹp, dịch vụ chuyên nghiệp, tiện nghi hiện đại.',
            'keywords' => 'khách sạn đồng nai, aurora hotel plaza, khách sạn 4 sao, đặt phòng khách sạn, khách sạn đồng nai',
    ...
    public static function generateHotelStructuredData() {
        $data = [
            ...
            'description' => 'Khách sạn 4 sao sang trọng tại trung tâm Đồng Nai',
            ...
            'address' => [
                '@type' => 'PostalAddress',
                'streetAddress' => '253, Phạm Văn Thuận, KP2, Phường Tam Hiệp, TP. Đồng Nai',
