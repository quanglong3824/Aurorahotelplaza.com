...
<style>
    ...
    .email-header { background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 40px 30px; text-align: center; }
    .email-body { padding: 40px 30px; }
    .email-footer { background-color: #1f2937; padding: 30px; text-align: center; color: #9ca3af; }
    .button { display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); color: #ffffff !important; text-decoration: none; font-weight: 600; text-align: center; }
    .info-box { background-color: #f9fafb; border-left: 4px solid #3b82f6; padding: 20px; margin: 20px 0; }
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="text-align: center;">
                            ...
                            <p style="color: #e0e7ff; margin: 0; font-size: 14px; text-transform: uppercase; letter-spacing: 2px;">
                                Luxury & Comfort
                            </p>
                        </td>
                    </tr>
