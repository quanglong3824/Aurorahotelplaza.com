...
<body class="bg-background-light dark:bg-background-dark font-body text-text-primary-light dark:text-text-primary-dark">
    <div class="relative flex min-h-screen w-full flex-col">
        ...
        <main class="flex h-full grow flex-col">
            ...
            <section class="relative min-h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div class="relative z-10 text-center px-4 pb-32 pt-[180px]">
                    <!-- Glass Badge -->
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center justify-between mb-8 px-2">
                        <p class="text-text-secondary-light dark:text-text-secondary-dark">
                            <?php _e('gallery_page.showing'); ?> <span
                                class="font-semibold text-accent"><?php echo count($page_images); ?></span>
                            <?php _e('gallery_page.of_total'); ?> <span
                                class="font-semibold"><?php echo $total_images; ?></span>
                            <?php _e('gallery_page.images'); ?>
                            <?php if ($current_category !== 'all'): ?>
                                - <?php _e('gallery_page.category'); ?>: <span
                                    class="font-semibold text-accent"><?php echo $categories[$current_category]['name']; ?></span>
                            <?php endif; ?>
                        </p>
                    ...
                    if ($pages_total > 1 && $pages_total < 100):
                        ...
                        <div class="flex items-center justify-center gap-3 mt-16">
                            ...
                            <?php if ($page_current > 1): ?>
                                <a href="?category=<?php echo $cat; ?>&page=<?php echo $prev_page; ?>" class="w-12 h-12 rounded-full flex items-center justify-center 
                          text-gray-600 hover:text-primary transition-all duration-300"
                            ...
                            <?php for ($i = 1; $i <= $pages_total; $i++): ?>
                                <?php if ($i == $page_current): ?>
                                    ...
                                    <span class="w-12 h-12 rounded-full flex items-center justify-center font-semibold" style="background: #f9fafb; 
                                 color: #cc9a2c; 
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="?category=<?php echo $cat; ?>&page=<?php echo $i; ?>" class="w-12 h-12 rounded-full flex items-center justify-center font-semibold
                              text-gray-600 dark:text-gray-300 hover:text-primary
                              transition-all duration-300" style="background: #f9fafb;
                              box-shadow: 4px 4px 10px #d1d5db, -4px -4px 10px #ffffff;">
                                        <?php echo $i; ?>
                                    </a>
                                <?php endif; ?>
                            ...
                            <?php if ($page_current < $pages_total): ?>
                                <a href="?category=<?php echo $cat; ?>&page=<?php echo $next_page; ?>" class="w-12 h-12 rounded-full flex items-center justify-center 
                          text-gray-600 hover:text-primary transition-all duration-300"
                                    style="background: #f9fafb; box-shadow: 4px 4px 10px #d1d5db, -4px -4px 10px #ffffff;">
    ...
    <div id="lightbox" class="lightbox-modal fixed inset-0 z-[9999] hidden p-4 bg-black/80 backdrop-blur-[12px]"
        style="display: none;">
        <!-- Close Button -->
