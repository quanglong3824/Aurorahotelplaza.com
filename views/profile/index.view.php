                    ...
                    <div class="mx-auto max-w-6xl">
                        ...
                        <div class="glass-card overflow-hidden min-h-[500px]">
                            ...
                            <div id="tab-info"
                                ...
                                <?php if (isset($user['tier_name']) && $user['tier_name'] && $user['benefits']): ?>
                                    <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between w-full md:w-auto gap-4">
                                                        <?php 
                                                            ...
                                                            echo '<span class="px-2 py-1 text-xs font-medium rounded-full ' . $info[1] . '">' . $info[0] . '</span>';
                                                        ?>
                                                ...
                                                <div class="flex justify-between items-start mb-3">
                                                    <div class="flex items-center gap-2">
                                                        <span
                                                            ...
                                                            <?php echo htmlspecialchars($c['contact_code'] ?: '#'); ?>
                                                        </span>
                                                    </div>
                                                    <?php 
                                                        $status = $c['status'];
