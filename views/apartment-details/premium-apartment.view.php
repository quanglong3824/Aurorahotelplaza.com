...
<head>
    ...
    <style>
        body.glass-page::before {
            background-image: url('<?php echo imgUrl('assets/img/premium-apartment/can-ho-premium-aurora-hotel-1.jpg'); ?>') !important;
        }
    </style>
</head>
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="glass-card p-8">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="flex items-center gap-3 text-white/80"><span class="material-symbols-outlined text-accent text-sm">desk</span> <?php _e('apartment_detail.amenity_desk'); ?></div>
                                    ...
                                    <div class="flex items-center gap-3 text-white/80"><span class="material-symbols-outlined text-accent text-sm">restaurant</span> <?php _e('apartment_detail.amenity_dishes'); ?></div>
