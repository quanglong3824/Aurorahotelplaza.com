        ...
        <main class="flex h-full grow flex-col">
            ...
            <div class="relative min-h-[60vh] flex items-center justify-center pt-[100px] pb-12 px-4">
                ...
                <div class="absolute inset-0 z-0">
                    <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment1.jpg.webp'); ?>"
                ...
                <div class="relative z-10 text-center max-w-4xl mx-auto">
                    <span
                        class="glass-badge-pill mb-6 mx-auto bg-accent/20 border-accent/40 text-accent"><?php _e('apartment_detail.badge_classical'); ?></span>
                    <h1
                        class="text-4xl md:text-6xl font-bold text-white mb-4 font-display text-shadow-lg tracking-tight">
                        <?php _e('apartment_detail.classical_family_name'); ?>
                    </h1>
                    <p class="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light leading-relaxed">
                        <?php _e('apartment_detail.classical_family_subtitle'); ?>
                    </p>
                </div>
            </div>
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div class="glass-amenity-card">
                                    ...
                                    <span
                                        class="font-bold text-accent"><?php _e('apartment_detail.family_bed'); ?></span>
                                </div>
                                <div class="glass-amenity-card">
                                ...
                                <div class="glass-amenity-card">
                                    ...
                                    <span class="font-bold text-accent">4-6
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment2.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment3.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment4.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment5.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment6.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="aspect-video rounded-2xl overflow-hidden glass-card-solid group">
                                        <img src="<?php echo imgUrl('assets/img/classical-family-apartment/classical-family-apartment7.jpg.webp'); ?>"
                                            class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            <select name="guests" class="glass-input glass-select w-full text-white">
                                                ...
                                                <option value="2" class="text-slate-800">2
                                                    <?php _e('apartment_detail.persons'); ?>
                                                </option>
                                                <option value="3" class="text-slate-800">3
                                                    <?php _e('apartment_detail.persons'); ?>
                                                </option>
                                                <option value="4" selected class="text-slate-800">4
                                                    <?php _e('apartment_detail.persons'); ?>
                                                </option>
                                                <option value="5" class="text-slate-800">5
                                                    <?php _e('apartment_detail.persons'); ?>
                                                </option>
                                                <option value="6" class="text-slate-800">6
                                                    <?php _e('apartment_detail.persons'); ?>
                                                </option>
                                            </select>
                                        </div>
