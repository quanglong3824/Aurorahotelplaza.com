                                    ...
                                    <div class="explore-card">
                                        <div class="relative h-48 overflow-hidden">
                                            ...
                                            <div
                                                ...
                                                <?php echo number_format($room['base_price'], 0, ',', '.'); ?>VND<?php _e('explore_page.per_night'); ?>
                                            </div>
                                        </div>
                                        <div class="p-5">
                                            <h3
                                    ...
                                    <div class="explore-card">
                                        <div class="relative h-48 overflow-hidden">
                                            ...
                                            <div
                                                ...
                                                <?php echo number_format($apt['base_price'], 0, ',', '.'); ?>VND<?php _e('explore_page.per_night'); ?>
                                            </div>
                                        </div>
                                        <div class="p-5">
                                            <h3
                            ...
                            <?php foreach ($featured_services as $service): ?>
                                <a href="service-detail.php?slug=<?php echo htmlspecialchars($service['slug']); ?>"
                                    ...
                                    <div class="glass-card p-6 text-center hover:-translate-y-2">
                                        ...
                                        <h3 class="font-bold text-sm text-white mb-1 group-hover:text-accent transition-colors">
