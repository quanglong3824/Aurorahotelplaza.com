...
<head>
    ...
    <style>
        body.glass-page::before {
            background-image: url('<?php echo imgUrl('assets/img/premium-twin/premium-deluxe-twin-aurora-1.jpg'); ?>') !important;
        }
    </style>
</head>
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div class="glass-amenity-card">
                                    ...
                                    <span class="font-bold text-accent">2-3 <?php _e('room_detail.guests'); ?></span>
                                </div>
                            </div>
                        </div>
