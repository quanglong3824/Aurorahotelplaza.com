            ...
            <div class="mx-auto w-full max-w-7xl px-4 py-8">
                ...
                <div class="bg-gradient-to-r from-primary-light to-accent p-8 rounded-xl text-white mb-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div
                                class="w-20 h-20 bg-white rounded-full flex items-center justify-center text-primary-light text-3xl font-bold">
                            ...
                            <div>
                                ...
                                <p class="text-white/80">
                                    <?php echo htmlspecialchars($user['phone'] ?? __('profile_full.not_updated')); ?>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            <?php if ($user['tier_name']): ?>
                                <div class="tier-badge"
                                    style="background: <?php echo $user['color_code']; ?>20; color: <?php echo $user['color_code']; ?>; border: 2px solid <?php echo $user['color_code']; ?>;">
                            ...
                            <a href="edit-profile.php"
                                class="bg-white/20 hover:bg-white/30 text-white px-3 py-2 rounded-lg transition"
                                title="Edit Profile">
                                <span class="material-symbols-outlined">edit</span>
                            </a>
                            <a href="logout.php"
                                class="bg-red-500/20 hover:bg-red-500/30 text-white border border-red-500/50 px-3 py-2 rounded-lg transition"
                                title="Logout">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div class="stat-card">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-content-dim text-sm"><?php _e('profile_full.current_points'); ?></p>
                    ...
                    <div class="stat-card">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-content-dim text-sm"><?php _e('profile_full.lifetime_points'); ?></p>
                    ...
                    <div class="stat-card">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-content-dim text-sm"><?php _e('profile_full.total_bookings'); ?></p>
                                <p class="text-3xl font-bold text-blue-400"><?php echo $stats['total_bookings']; ?></p>
                            </div>
                            <span class="material-symbols-outlined text-4xl text-blue-400">hotel</span>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-content-dim text-sm"><?php _e('profile_full.total_spent'); ?></p>
                                <p class="text-2xl font-bold text-green-400">
                                    <?php echo number_format($stats['total_spent']); ?> đ
                                </p>
                            </div>
                            <span class="material-symbols-outlined text-4xl text-green-400">payments</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Membership Benefits -->
                <?php if ($user['tier_name']): ?>
                    <div class="glass-panel mb-6 text-white">
                        <h2 class="text-xl font-bold mb-4">🎁 <?php _e('profile_full.tier_benefits'); ?>
                            <?php echo $user['tier_name']; ?>
                        </h2>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center gap-3">
                                <span class="material-symbols-outlined text-accent">discount</span>
                                <span><?php _e('profile_full.discount'); ?>:
                                    <strong><?php echo $user['discount_percentage']; ?>%</strong></span>
                            </div>
                            <?php
                ...
                <div class="glass-panel text-white">
                    <div class="border-b border-white/10 flex gap-4 px-6">
                                    ...
                                    <div class="border rounded-lg p-4 hover:shadow-md transition">
                                        <div class="flex justify-between items-start mb-3">
                                            <div>
                                                ...
                                                <p class="text-gray-600"><?php _e('profile_full.booking_code'); ?>:
                                                    <?php echo $booking['booking_code']; ?>
                                                </p>
                                                <?php if ($booking['room_number']): ?>
                                                    <p class="text-gray-600"><?php _e('profile_full.room'); ?>:
                                                        <?php echo $booking['room_number']; ?> - <?php _e('profile_full.floor'); ?>
                            ...
                            <div class="space-y-3">
                                <?php foreach ($points_history as $trans): ?>
                                    <div class="flex justify-between items-center border-b pb-3">
                                        <div class="flex items-center gap-3">
                                            <span
                                                class="material-symbols-outlined text-2xl <?php echo $trans['transaction_type'] == 'earn' ? 'text-green-600' : 'text-red-600'; ?>">
                                                <?php echo $trans['transaction_type'] == 'earn' ? 'add_circle' : 'remove_circle'; ?>
                                            </span>
                                            <div>
                                                <p class="font-semibold"><?php echo htmlspecialchars($trans['description']); ?>
                                                </p>
                                        ...
                                        <div class="text-right">
                                            <p
                                                class="font-bold text-lg <?php echo $trans['transaction_type'] == 'earn' ? 'text-green-600' : 'text-red-600'; ?>">
                                    ...
                                    <div class="border rounded-lg p-4">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600"><?php _e('profile_full.method'); ?>:
                                                    <?php echo strtoupper($payment['payment_method']); ?>
                                                </p>
                                                <?php if ($payment['transaction_id']): ?>
                                                    <p class="text-sm text-gray-600"><?php _e('profile_full.transaction_id'); ?>:
                    ...
                    <div id="tab-contacts" class="tab-content p-6">
                        ...
                        <?php if (empty($contacts)): ?>
                            <div class="text-center py-12">
                                ...
                                <a href="contact.php"
                                    class="inline-flex items-center gap-2 bg-accent text-white px-6 py-3 rounded-lg font-medium hover:opacity-90 transition">
                                    ...
                                    <div class="border rounded-xl p-5 hover:shadow-md transition bg-white">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-500 font-mono">
                                                        #<?php echo htmlspecialchars($contact['display_code']); ?></p>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-4 mb-3">
                                            <p class="text-gray-700 text-sm leading-relaxed">
                                                <?php echo nl2br(htmlspecialchars(mb_substr($contact['message'], 0, 200))); ?>
                                                <?php echo mb_strlen($contact['message']) > 200 ? '...' : ''; ?>
                                            </p>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center text-sm">
                                            ...
                                            <button onclick="viewContactDetail(<?php echo $contact['id']; ?>)"
                                                class="text-accent hover:underline font-medium flex items-center gap-1">
