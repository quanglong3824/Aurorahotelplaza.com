        ...
        <main class="flex h-full grow flex-col">
            ...
            <div class="relative min-h-[60vh] flex items-center justify-center pt-[100px] pb-12 px-4">
                ...
                <div class="relative z-10 text-center max-w-4xl mx-auto">
                    <span
                        class="glass-badge-pill mb-6 mx-auto bg-accent/20 border-accent/40 text-accent"><?php _e('room_detail.vip_suite_badge'); ?></span>
                    <h1
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="glass-card p-8">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-6">
                                    ...
                                    <div class="flex items-center gap-3 text-white/80">
                                        <span class="material-symbols-outlined text-accent text-sm">check_circle</span>
                                        <?php _e('room_detail.amenity_sofa'); ?>
                                    </div>
                                    <div class="flex items-center gap-3 text-white/80">
                                        <span class="material-symbols-outlined text-accent text-sm">check_circle</span>
                                        <?php _e('room_detail.amenity_bathtub'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-16">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="glass-card overflow-hidden group aspect-video md:col-span-2 md:row-span-2">
                                <img src="<?php echo imgUrl('assets/img/vip-suite/vip-suite-aurora-hotel-1.jpg'); ?>" 
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                            <div class="glass-card overflow-hidden group aspect-video">
                                <img src="<?php echo imgUrl('assets/img/vip-suite/vip-suite-aurora-hotel-2.jpg'); ?>" 
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                            <div class="glass-card overflow-hidden group aspect-video">
                                <img src="<?php echo imgUrl('assets/img/vip-suite/vip-suite-aurora-hotel-3.jpg'); ?>" 
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                        </div>
                    </div>
