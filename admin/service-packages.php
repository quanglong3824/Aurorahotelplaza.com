    ...
    <?php else: ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php foreach ($packages as $package): ?>
                <div
                    class="card hover:shadow-lg transition-shadow <?php echo $package['is_featured'] ? 'border-2 border-accent' : ''; ?>">
                    <div class="card-body">
                                ...
                                <ul class="text-sm space-y-1">
                                    ...
                                    foreach (array_slice($features, 0, 3) as $feature):
                                        ...
                                        <li class="flex items-start gap-2">
                                            ...
                                            <span
                                                class="text-text-secondary-light dark:text-text-secondary-dark"><?php echo htmlspecialchars(trim($feature)); ?></span>
                                        </li>
                                    <?php endforeach; ?>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button onclick="deletePackage(<?php echo $package['package_id']; ?>)" class="btn btn-danger">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="slug" name="slug" class="form-input" required
                            placeholder="vd: wedding-service">
                    </div>
    ...
    <div class="modal-content max-w-3xl">
        ...
        <div class="modal-body">
            <form id="packageForm">
                ...
                <input type="hidden" id="package_service_id" name="service_id"
                    value="<?php echo htmlspecialchars($service_filter); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        <label class="form-label">Slug (URL) *</label>
                        <input type="text" id="package_slug" name="slug" class="form-input" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="price_unit" name="price_unit" class="form-input"
                            placeholder="vd: bàn, người, ngày" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Thứ tự hiển thị</label>
                        <input type="number" id="package_sort_order" name="sort_order" class="form-input" value="0"
                            min="0">
                    </div>
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <textarea id="features" name="features" class="form-textarea" rows="6"
                            placeholder="Menu 8 món Á - Âu&#10;Trang trí sảnh cơ bản&#10;Âm thanh ánh sáng"></textarea>
                        <p class="text-xs text-text-secondary-light dark:text-text-secondary-dark mt-1">Mỗi tính năng
                            trên 1 dòng</p>
                    </div>
