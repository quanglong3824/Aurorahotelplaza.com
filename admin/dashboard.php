...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <!-- Revenue Today -->
    <div
        class="stat-card bg-gradient-to-br from-[#d4af37]/10 to-[#b8941f]/10 border-2 border-[#d4af37]/30 relative overflow-hidden group">
        <div
            class="absolute top-0 right-0 w-32 h-32 bg-[#d4af37]/10 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500">
        </div>
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-3">
                <div
                    class="w-12 h-12 bg-gradient-to-br from-[#d4af37] to-[#b8941f] rounded-xl flex items-center justify-center shadow-lg">
                    <span class="material-symbols-outlined text-[#1a1a1a] text-xl font-bold">payments</span>
                </div>
                <span
                    class="text-xs font-bold px-3 py-1 bg-green-100 text-green-700 rounded-full">+<?php echo number_format($revenue_growth, 1); ?>%</span>
            </div>
    ...
    <!-- Occupancy Rate -->
    <div
        class="stat-card bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 relative overflow-hidden group">
        <div
            class="absolute top-0 right-0 w-32 h-32 bg-blue-200/30 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500">
        </div>
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-3">
                <div
                ...
                <span
                    class="text-xs font-bold px-3 py-1 bg-blue-100 text-blue-700 rounded-full"><?php echo number_format($occupancy_rate, 0); ?>%</span>
            </div>
            ...
            <p class="text-3xl font-bold text-blue-600 mb-2">
                <?php echo $stats['total_rooms'] - $stats['available_rooms']; ?>/<?php echo $stats['total_rooms']; ?>
            </p>
    ...
    <!-- Check-ins Today -->
    <div
        class="stat-card bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 relative overflow-hidden group">
        <div
            class="absolute top-0 right-0 w-32 h-32 bg-green-200/30 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500">
        </div>
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-3">
                <div
    ...
    <!-- Pending Bookings -->
    <div
        class="stat-card bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 relative overflow-hidden group">
        <div
            class="absolute top-0 right-0 w-32 h-32 bg-orange-200/30 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500">
        </div>
        <div class="relative z-10">
            <div class="flex items-center justify-between mb-3">
                <div
                ...
                <?php if ($stats['pending_bookings'] > 0): ?>
                    <span class="animate-pulse text-xs font-bold px-3 py-1 bg-red-100 text-red-700 rounded-full">Cần xử
                        lý</span>
                <?php endif; ?>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="space-y-4">
                    <?php foreach ($top_room_types as $index => $room): ?>
                        <div class="flex items-center gap-4">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-[#d4af37] to-[#b8941f] rounded-lg flex items-center justify-center font-bold text-[#1a1a1a]">
                                <?php echo $index + 1; ?>
                            </div>
                            <div class="flex-1">
    ...
    <div class="card">
        ...
        <div class="card-body space-y-3">
            <a href="bookings.php"
                class="flex items-center gap-3 p-4 bg-gradient-to-r from-[#d4af37]/10 to-[#b8941f]/10 rounded-xl hover:shadow-md transition-all group">
                <div
                    class="w-10 h-10 bg-gradient-to-br from-[#d4af37] to-[#b8941f] rounded-lg flex items-center justify-center">
            ...
            <a href="rooms.php"
                class="flex items-center gap-3 p-4 bg-blue-50 rounded-xl hover:shadow-md transition-all group">
            ...
            <a href="customers.php"
                class="flex items-center gap-3 p-4 bg-green-50 rounded-xl hover:shadow-md transition-all group">
            ...
            <a href="reports.php"
                class="flex items-center gap-3 p-4 bg-purple-50 rounded-xl hover:shadow-md transition-all group">
            ...
            <?php else: ?>
                <div class="space-y-3">
                    <?php foreach ($upcoming_checkins as $booking): ?>
                        <div
                            class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-slate-800 rounded-lg hover:shadow-md transition-all">
                            <div
                ...
                <div class="space-y-3">
                    <?php foreach (array_slice($recent_activities, 0, 5) as $activity): ?>
                        <div class="flex items-start gap-3 text-sm">
                            <div
                                class="w-8 h-8 bg-gray-200 dark:bg-slate-700 rounded-full flex items-center justify-center flex-shrink-0">
