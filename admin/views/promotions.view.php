                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span
                                    class="badge badge-<?php echo $promo['status'] === 'active' ? 'success' : ($promo['status'] === 'expired' ? 'danger' : 'secondary'); ?>">
                                    <?php
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-3">
                                <div>
                                    ...
                                    <p class="font-mono font-bold text-lg text-accent">
                                        <?php echo htmlspecialchars($promo['promotion_code']); ?></p>
                                </div>
            ...
            <form id="promotionForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="discount_value" name="discount_value" class="form-input" min="0"
                            step="0.01" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="usage_limit" name="usage_limit" class="form-input" min="0"
                            placeholder="Để trống = không giới hạn">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Số lần/người</label>
                        <input type="number" id="usage_per_user" name="usage_per_user" class="form-input" min="1"
                            value="1">
                    </div>
