...
<div class="flex items-center justify-between mb-6">
    <form method="GET" class="flex gap-2 flex-wrap">
        ...
        <select name="category" class="form-select">
            ...
            <option value="restaurant" <?php echo $category_filter === 'restaurant' ? 'selected' : ''; ?>>Nhà hàng
            </option>
            <option value="laundry" <?php echo $category_filter === 'laundry' ? 'selected' : ''; ?>>Giặt ủi</option>
            <option value="transport" <?php echo $category_filter === 'transport' ? 'selected' : ''; ?>>Vận chuyển
            </option>
            ...
            <div class="card hover:shadow-lg transition-shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            onclick="toggleServiceStatus(<?php echo $service['service_id']; ?>, <?php echo $service['available'] ? 0 : 1; ?>)"
                            class="btn btn-secondary">
                            <span
                                class="material-symbols-outlined text-sm"><?php echo $service['available'] ? 'visibility_off' : 'visibility'; ?></span>
                        </button>
                        <button onclick="deleteService(<?php echo $service['service_id']; ?>)" class="btn btn-danger">
