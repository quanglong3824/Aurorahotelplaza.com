    ...
    <div class="card-header">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Aurora Hotel Plaza - 4 sao | 253, Phạm Văn Thuận, KP2, Phường Tam Hiệp, TP. Đồng Nai
            </p>
        </div>
    </div>
    <div class="card-body">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800">
                                ...
                                <td class="text-right text-gray-500">
                                    <?php if ($type['price_published']): ?>
                                        <span
                                            class="line-through"><?php echo number_format($type['price_published'], 0, ',', '.'); ?>VND</span>
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                </td>
                                <td class="text-right">
                                    <span class="font-bold text-lg" style="color: #d4af37;">
                                        <?php echo $type['price_double_occupancy']
                                            ? number_format($type['price_double_occupancy'], 0, ',', '.') . 'VND'
                                            : number_format($type['base_price'], 0, ',', '.') . 'VND'; ?>
                                    </span>
                                </td>
                                <td class="text-right">
                                    <?php echo $type['price_single_occupancy']
                                        ? number_format($type['price_single_occupancy'], 0, ',', '.') . 'VND'
                                        : '-'; ?>
                                </td>
                                <td class="text-right">
                                    <?php if ($type['price_short_stay']): ?>
                                        <span class="text-blue-600 font-semibold">
                                            <?php echo number_format($type['price_short_stay'], 0, ',', '.'); ?>VND
                                        </span>
                                        <br>
                        ...
                        <?php foreach ($apartments as $apt):
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800">
                                    ...
                                    <td class="text-right">
                                        <span class="font-bold" style="color: #d4af37;">
                                            <?php echo number_format($apt['price_daily_single'], 0, ',', '.'); ?>VND
                                        </span>
                                    </td>
                                    <td class="text-right">
                                        <?php echo $apt['price_weekly_single']
                                            ? number_format($apt['price_weekly_single'], 0, ',', '.') . 'VND'
                                            : '-'; ?>
                                    </td>
                                    <td class="text-right">
                                        <?php if ($apt['price_avg_weekly_single']): ?>
                                            <span class="text-green-600 font-semibold">
                                                <?php echo number_format($apt['price_avg_weekly_single'], 0, ',', '.'); ?>VND
                                            </span>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                            ...
                            <?php if ($hasTwoPerson): ?>
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800">
                                    ...
                                    <td class="text-right">
                                        <span class="font-bold" style="color: #d4af37;">
                                            <?php echo number_format($apt['price_daily_double'], 0, ',', '.'); ?>VND
                                        </span>
                                    </td>
                                    <td class="text-right">
                                        <?php echo $apt['price_weekly_double']
                                            ? number_format($apt['price_weekly_double'], 0, ',', '.') . 'VND'
                                            : '-'; ?>
                                    </td>
                                    <td class="text-right">
                                        <?php if ($apt['price_avg_weekly_double']): ?>
                                            <span class="text-green-600 font-semibold">
                                                <?php echo number_format($apt['price_avg_weekly_double'], 0, ',', '.'); ?>VND
                                            </span>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <span class="text-2xl font-bold" style="color: #d4af37;">650.000VND</span>
            </div>
