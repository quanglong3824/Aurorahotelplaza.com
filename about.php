                ...
                <div class="max-w-7xl mx-auto px-4">
                    <div class="text-center mb-16">
                        ...
                        <h2 class="font-display text-3xl md:text-4xl font-bold mt-2 mb-4 text-white">
                            <?php _e('about_page.what_we_offer'); ?>
                        </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="value-card">
                            ...
                            <h3 class="font-display text-xl font-bold text-white mb-3">
                                <?php _e('about_page.dedicated_service'); ?>
                            </h3>
                        ...
                        <div class="value-card">
                            ...
                            <h3 class="font-display text-xl font-bold text-white mb-3">
                                <?php _e('about_page.prime_location'); ?>
                            </h3>
                            <p class="text-white/70 text-sm leading-relaxed">
                        ...
                        <div class="value-card">
                            ...
                            <h3 class="font-display text-xl font-bold text-white mb-3">
                                <?php _e('about_page.diverse_cuisine'); ?>
                            </h3>
                            <p class="text-white/70 text-sm leading-relaxed">
                        ...
                        <div class="value-card">
                            <div class="utility-icon mb-6 mx-auto"><span class="material-symbols-outlined">spa</span>
                            </div>
                            <h3 class="font-display text-xl font-bold text-white mb-3">
                                <?php _e('about_page.modern_amenities'); ?>
                            </h3>
                            <p class="text-white/70 text-sm leading-relaxed">
                        ...
                        <div class="value-card">
                            ...
                            <h3 class="font-display text-xl font-bold text-white mb-3">
                                <?php _e('about_page.quality_guaranteed'); ?>
                            </h3>
                            <p class="text-white/70 text-sm leading-relaxed">
