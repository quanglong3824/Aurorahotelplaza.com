        ...
        <main class="flex h-full grow flex-col pt-24 pb-16">
            <div class="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <div class="mb-6 no-print">
                    <a href="booking-detail.php?id=<?php echo $booking_id; ?>"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                        ...
                        <div
                            class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 p-8 rounded-xl flex items-center justify-center mb-6">
                        ...
                        <div class="space-y-3 no-print">
                            <button onclick="openQRPopup()"
                                class="w-full bg-gradient-to-r from-[#d4af37] to-[#b8941f] text-white py-3 px-6 rounded-xl font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2">
                                <span class="material-symbols-outlined">qr_code_2</span>
                                <?php _e('profile_qrcode.download_qr'); ?>
                            </button>

                            <button onclick="printBookingQR()"
                                class="w-full bg-blue-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-blue-700 transition-all flex items-center justify-center gap-2">
                                <span class="material-symbols-outlined">print</span>
                                In QR Code
                            </button>

                            <button onclick="shareQR()"
                                class="w-full bg-gray-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-gray-700 transition-all flex items-center justify-center gap-2">
                    ...
                    <div id="printArea" class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                        <div class="text-center mb-6 print:mb-4">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 text-sm">Xác nhận đặt phòng / Booking
                                Confirmation</p>
                        </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl">
                                ...
                                <div class="space-y-3 text-sm">
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="font-semibold text-gray-900 dark:text-white"><?php echo htmlspecialchars($booking['type_name']); ?></span>
                                    </div>
                                    <?php if ($booking['room_number']): ?>
                                        <div class="flex justify-between">
                                            <span class="text-gray-500 dark:text-gray-400">Số phòng</span>
                                            <span
                                                class="font-bold text-green-600 dark:text-green-400 text-lg"><?php echo htmlspecialchars($booking['room_number']); ?></span>
                                        </div>
                                        <?php if ($booking['floor']): ?>
                                            <div class="flex justify-between">
                                                <span class="text-gray-500 dark:text-gray-400">Tầng</span>
                                                <span
                                                    class="font-semibold text-gray-900 dark:text-white"><?php echo $booking['floor']; ?></span>
                                            </div>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <div class="bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded-lg text-center">
                                            <p class="text-sm text-yellow-700 dark:text-yellow-300">Phòng sẽ được phân khi
                                                check-in</p>
                                        </div>
                                    <?php endif; ?>
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        <span class="text-gray-500 dark:text-gray-400">Số phòng</span>
                                        <span
                                            class="font-semibold text-gray-900 dark:text-white"><?php echo $booking['num_rooms']; ?>
                                            phòng</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-xl text-center">
                                    ...
                                    <p class="font-bold text-xl text-green-700 dark:text-green-300">
                                ...
                                <div class="bg-red-50 dark:bg-red-900/20 p-4 rounded-xl text-center">
                                    ...
                                    <p class="font-bold text-xl text-red-700 dark:text-red-300">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span
                                            class="text-gray-900 dark:text-white"><?php echo number_format($room_per_night_qr, 0, ',', '.'); ?>VNĐ</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500 dark:text-gray-400">Tiền phòng
                                            ...
                                            phòng)</span>
                                        <span
                                            class="text-gray-900 dark:text-white"><?php echo number_format($room_total_qr, 0, ',', '.'); ?>VNĐ</span>
                                    </div>
                                    ...
                                    <?php if ($booking['service_fee'] > 0): ?>
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="text-gray-900 dark:text-white"><?php echo number_format($booking['service_fee'], 0, ',', '.'); ?>VNĐ</span>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div
                                ...
                                <p>Đặt phòng lúc: <?php echo date('H:i d/m/Y', strtotime($booking['created_at'])); ?>
                                </p>
                            </div>
                        </div>
                    </div>
