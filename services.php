                    ...
                    <?php if (!empty($utility_services)): ?>
                        <div class="mb-20">
                            <div class="text-center mb-10">
                                <span class="text-[#d4af37] font-semibold text-sm uppercase tracking-wider">Aurora Hotel
                                    Plaza</span>
                                        ...
                                        <?php if ($service['thumbnail']): ?>
                                            <div class="service-img-container">
                                                ...
                                                <?php if ($service['is_featured']): ?>
                                                    <div
                                                        class="absolute top-4 right-4 bg-[#d4af37] text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg flex items-center gap-1">
                                                ...
                                                <div class="packages-list-mini">
                                                    <?php foreach (array_slice($service['packages'], 0, 3) as $pkg): ?>
                                                        <div class="package-item-mini">
                                                            ...
                                                            <span
                                                                class="package-price-mini"><?php echo $pkg['price'] > 0 ? number_format($pkg['price'], 0, ',', '.') . 'VND' : __('nav.contact'); ?></span>
                                                        </div>
                                                    <?php endforeach; ?>
