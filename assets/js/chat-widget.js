    ...
    parseAiContent(text, msgId = 0, isBot = true) {
        ...
        html = html.replace(/\[BOOK_NOW_BTN\]/gi, () => {
            return `<div style="margin:12px 0;">
                <a href="https://aurorahotelplaza.com/booking/" target="_blank" style="display:inline-flex; align-items:center; gap:8px; background:linear-gradient(135deg, #d4af37, #b48a2a); color:#fff; padding:10px 22px; border-radius:10px; font-size:13px; font-weight:700; text-decoration:none; box-shadow:0 6px 15px rgba(212,175,55,0.3); transition:all 0.3s; border:1px solid rgba(255,255,255,0.1);" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                    <span class="material-symbols-outlined" style="font-size:18px;">calendar_month</span> ĐẶT PHÒNG NGAY
                </a>
            </div>`;
        });
