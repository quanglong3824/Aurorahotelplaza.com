...
INSERT INTO `blog_likes` (`like_id`, `post_id`, `user_id`, `ip_address`, `created_at`) VALUES
(2, 3, 5, '115.74.225.100', '2025-12-15 08:49:59'),
(3, 4, 5, '115.74.225.100', '2025-12-15 09:20:09');
...
--
-- Cấu trúc bảng cho bảng `blog_ratings`
--
...
--
-- Đang đổ dữ liệu cho bảng `blog_ratings`
--

INSERT INTO `blog_ratings` (`rating_id`, `post_id`, `user_id`, `ip_address`, `rating`, `created_at`) VALUES
(1, 3, 5, '115.74.225.100', 5, '2025-12-15 08:49:07'),
(2, 4, 5, '115.74.225.100', 5, '2025-12-15 09:20:09');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `blog_shares`
--
...
ALTER TABLE `blog_likes`
  ...
  ADD KEY `idx_user_post` (`post_id`,`user_id`),
  ADD KEY `idx_ip_post` (`post_id`,`ip_address`);
...
--
-- AUTO_INCREMENT cho bảng `blog_ratings`
--
ALTER TABLE `blog_ratings`
  MODIFY `rating_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `blog_shares`
--
ALTER TABLE `blog_shares`
